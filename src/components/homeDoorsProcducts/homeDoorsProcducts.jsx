                ...
                <ul className='products-list__category__list'>
                    {
                        categories.map((e, i) => (
                            <li
                                key={i}
                                className={e.id === category ? 'products-list__category__item products-list__category__item--selected' : 'products-list__category__item'}
                        ...
                        door.map((e, i) => (
                            <li className='products__item' key={i}>
                                <div className='products__item__box'>
                                    <img className='products__image' src={e.image} alt="bathroom things" width={300} height={210} />
                                </div>
